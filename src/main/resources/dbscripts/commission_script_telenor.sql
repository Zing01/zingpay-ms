...
INSERT INTO `zingpay`.`ref_service` (`SERVICE_ID`, `SERVICE_NAME`, `PRICE`, `RETAIL_PRICE`, `SERVICE_TYPE_ID`, `SERVICE_PROVIDER_ID`, `ACTIVE`, `SERVICE_CODE`)
select 153, '4G Weekly Ultra- alternate channels', '200', '200', (Select id from ref_service_type rst where rst.value = 'BUNDLE'), SERVICE_PROVIDER_ID, 1, '501925' from ref_service_provider
where SERVICE_PROVIDER_SHORT_NAME = 'telenor' and SERVICE_BROKER_ID=(select SERVICE_BROKER_ID from ref_service_broker where SERVICE_BROKER_NAME = 'TELENOR');
...
INSERT INTO `zingpay`.`ref_service` (`SERVICE_ID`, `SERVICE_NAME`, `PRICE`, `RETAIL_PRICE`, `SERVICE_TYPE_ID`, `SERVICE_PROVIDER_ID`, `ACTIVE`, `SERVICE_CODE`)
select 156, 'Easy Card 600 Replica', '600', '600', (Select id from ref_service_type rst where rst.value = 'BUNDLE'), SERVICE_PROVIDER_ID, 1, '501895' from ref_service_provider
where SERVICE_PROVIDER_SHORT_NAME = 'telenor' and SERVICE_BROKER_ID=(select SERVICE_BROKER_ID from ref_service_broker where SERVICE_BROKER_NAME = 'TELENOR');
